...
#ifndef GOOGLE_PROTOBUF_INCLUDED_LGDDY_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_LGDDY_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_LGDDY_2eproto
...
struct TableStruct_LGDDY_2eproto {
...
template<> ::LGDDY::SC_stSmallGameInfo* Arena::CreateMaybeMessage<::LGDDY::SC_stSmallGameInfo>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace LGDDY {

enum EMsgIDLGDDY : int {
  LABA_MSG_CS_START = 0,
  ...
  EMsgIDLGDDY_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  EMsgIDLGDDY_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool EMsgIDLGDDY_IsValid(int value);
constexpr EMsgIDLGDDY EMsgIDLGDDY_MIN = LABA_MSG_CS_START;
constexpr EMsgIDLGDDY EMsgIDLGDDY_MAX = LABA_MSG_SC_UPDATE_PRIZE_POOL;
constexpr int EMsgIDLGDDY_ARRAYSIZE = EMsgIDLGDDY_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* EMsgIDLGDDY_descriptor();
template<typename T>
inline const std::string& EMsgIDLGDDY_Name(T enum_t_value) {
  static_assert(::std::is_same<T, EMsgIDLGDDY>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function EMsgIDLGDDY_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    EMsgIDLGDDY_descriptor(), enum_t_value);
}
inline bool EMsgIDLGDDY_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, EMsgIDLGDDY* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<EMsgIDLGDDY>(
    EMsgIDLGDDY_descriptor(), name, value);
}
// ===================================================================

class SC_CheckOut PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:LGDDY.SC_CheckOut) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:LGDDY.SC_CheckOut)
 private:
  class _Internal;
...
class SC_SyncGold PROTOBUF_FINAL :
 ...
 public:
  ...
  // @@protoc_insertion_point(class_scope:LGDDY.SC_SyncGold)
 private:
  class _Internal;
...
class SC_SceneInfo PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:LGDDY.SC_SceneInfo) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:LGDDY.SC_SceneInfo)
 private:
  class _Internal;
...
class SC_stSmallGameInfo PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:LGDDY.SC_stSmallGameInfo) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "LGDDY.SC_stSmallGameInfo";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:LGDDY.SC_stSmallGameInfo)
 private:
  class _Internal;
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_CheckOut::result(int index) const {
  // @@protoc_insertion_point(field_get:LGDDY.SC_CheckOut.result)
  return _internal_result(index);
}
inline void SC_CheckOut::set_result(int index, ::PROTOBUF_NAMESPACE_ID::int32 value) {
  result_.Set(index, value);
  // @@protoc_insertion_point(field_set:LGDDY.SC_CheckOut.result)
}
...
inline void SC_CheckOut::add_result(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_add:LGDDY.SC_CheckOut.result)
}
...
SC_CheckOut::result() const {
  // @@protoc_insertion_point(field_list:LGDDY.SC_CheckOut.result)
...
SC_CheckOut::mutable_result() {
  // @@protoc_insertion_point(field_mutable_list:LGDDY.SC_CheckOut.result)
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_CheckOut::reward_line_fruit_count(int index) const {
  // @@protoc_insertion_point(field_get:LGDDY.SC_CheckOut.reward_line_fruit_count)
...
inline void SC_CheckOut::set_reward_line_fruit_count(int index, ::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:LGDDY.SC_CheckOut.reward_line_fruit_count)
}
...
inline void SC_CheckOut::add_reward_line_fruit_count(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_add:LGDDY.SC_CheckOut.reward_line_fruit_count)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int32 >&
...
SC_CheckOut::reward_line_fruit_count() const {
  // @@protoc_insertion_point(field_list:LGDDY.SC_CheckOut.reward_line_fruit_count)
...
SC_CheckOut::mutable_reward_line_fruit_count() {
  // @@protoc_insertion_point(field_mutable_list:LGDDY.SC_CheckOut.reward_line_fruit_count)
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_CheckOut::win_pei_lv() const {
  // @@protoc_insertion_point(field_get:LGDDY.SC_CheckOut.win_pei_lv)
...
inline void SC_CheckOut::set_win_pei_lv(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:LGDDY.SC_CheckOut.win_pei_lv)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int64 SC_CheckOut::cur_gold() const {
  // @@protoc_insertion_point(field_get:LGDDY.SC_CheckOut.cur_gold)
...
inline void SC_CheckOut::set_cur_gold(::PROTOBUF_NAMESPACE_ID::int64 value) {
  ...
  // @@protoc_insertion_point(field_set:LGDDY.SC_CheckOut.cur_gold)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_CheckOut::win_gold() const {
  // @@protoc_insertion_point(field_get:LGDDY.SC_CheckOut.win_gold)
...
inline void SC_CheckOut::set_win_gold(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:LGDDY.SC_CheckOut.win_gold)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_CheckOut::total_win_gold() const {
  // @@protoc_insertion_point(field_get:LGDDY.SC_CheckOut.total_win_gold)
...
inline void SC_CheckOut::set_total_win_gold(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:LGDDY.SC_CheckOut.total_win_gold)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_CheckOut::free_times() const {
  // @@protoc_insertion_point(field_get:LGDDY.SC_CheckOut.free_times)
...
inline void SC_CheckOut::set_free_times(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:LGDDY.SC_CheckOut.free_times)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_CheckOut::multiple() const {
  // @@protoc_insertion_point(field_get:LGDDY.SC_CheckOut.multiple)
...
inline void SC_CheckOut::set_multiple(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:LGDDY.SC_CheckOut.multiple)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_CheckOut::jackpot_value() const {
  // @@protoc_insertion_point(field_get:LGDDY.SC_CheckOut.jackpot_value)
...
inline void SC_CheckOut::set_jackpot_value(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:LGDDY.SC_CheckOut.jackpot_value)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_CheckOut::small_game_times() const {
  // @@protoc_insertion_point(field_get:LGDDY.SC_CheckOut.small_game_times)
...
inline void SC_CheckOut::set_small_game_times(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:LGDDY.SC_CheckOut.small_game_times)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int64 SC_SyncGold::gold() const {
  // @@protoc_insertion_point(field_get:LGDDY.SC_SyncGold.gold)
...
inline void SC_SyncGold::set_gold(::PROTOBUF_NAMESPACE_ID::int64 value) {
  ...
  // @@protoc_insertion_point(field_set:LGDDY.SC_SyncGold.gold)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_SyncGold::last_win_gold() const {
  // @@protoc_insertion_point(field_get:LGDDY.SC_SyncGold.last_win_gold)
...
inline void SC_SyncGold::set_last_win_gold(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:LGDDY.SC_SyncGold.last_win_gold)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_SyncGold::total_win_gold() const {
  // @@protoc_insertion_point(field_get:LGDDY.SC_SyncGold.total_win_gold)
  return _internal_total_win_gold();
}
...
inline void SC_SyncGold::set_total_win_gold(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_total_win_gold(value);
  // @@protoc_insertion_point(field_set:LGDDY.SC_SyncGold.total_win_gold)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_SceneInfo::left_free_game_cnt() const {
  // @@protoc_insertion_point(field_get:LGDDY.SC_SceneInfo.left_free_game_cnt)
...
inline void SC_SceneInfo::set_left_free_game_cnt(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:LGDDY.SC_SceneInfo.left_free_game_cnt)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_SceneInfo::multiple() const {
  // @@protoc_insertion_point(field_get:LGDDY.SC_SceneInfo.multiple)
  return _internal_multiple();
}
...
inline void SC_SceneInfo::set_multiple(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_multiple(value);
  // @@protoc_insertion_point(field_set:LGDDY.SC_SceneInfo.multiple)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_SceneInfo::beton_gold(int index) const {
  // @@protoc_insertion_point(field_get:LGDDY.SC_SceneInfo.beton_gold)
...
inline void SC_SceneInfo::set_beton_gold(int index, ::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:LGDDY.SC_SceneInfo.beton_gold)
}
...
inline void SC_SceneInfo::add_beton_gold(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_add:LGDDY.SC_SceneInfo.beton_gold)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int32 >&
...
SC_SceneInfo::beton_gold() const {
  // @@protoc_insertion_point(field_list:LGDDY.SC_SceneInfo.beton_gold)
...
SC_SceneInfo::mutable_beton_gold() {
  // @@protoc_insertion_point(field_mutable_list:LGDDY.SC_SceneInfo.beton_gold)
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_SceneInfo::free_game_cot_total() const {
  // @@protoc_insertion_point(field_get:LGDDY.SC_SceneInfo.free_game_cot_total)
...
inline void SC_SceneInfo::set_free_game_cot_total(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:LGDDY.SC_SceneInfo.free_game_cot_total)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_SceneInfo::free_game_gold() const {
  // @@protoc_insertion_point(field_get:LGDDY.SC_SceneInfo.free_game_gold)
...
inline void SC_SceneInfo::set_free_game_gold(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:LGDDY.SC_SceneInfo.free_game_gold)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_SceneInfo::small_count() const {
  // @@protoc_insertion_point(field_get:LGDDY.SC_SceneInfo.small_count)
...
inline void SC_SceneInfo::set_small_count(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:LGDDY.SC_SceneInfo.small_count)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_stSmallGameInfo::small_game_tatol_conut() const {
  // @@protoc_insertion_point(field_get:LGDDY.SC_stSmallGameInfo.small_game_tatol_conut)
...
inline void SC_stSmallGameInfo::set_small_game_tatol_conut(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:LGDDY.SC_stSmallGameInfo.small_game_tatol_conut)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_stSmallGameInfo::small_game_conut() const {
  // @@protoc_insertion_point(field_get:LGDDY.SC_stSmallGameInfo.small_game_conut)
...
inline void SC_stSmallGameInfo::set_small_game_conut(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:LGDDY.SC_stSmallGameInfo.small_game_conut)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_stSmallGameInfo::game_tatol_gold() const {
  // @@protoc_insertion_point(field_get:LGDDY.SC_stSmallGameInfo.game_tatol_gold)
...
inline void SC_stSmallGameInfo::set_game_tatol_gold(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:LGDDY.SC_stSmallGameInfo.game_tatol_gold)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_stSmallGameInfo::icon_type() const {
  // @@protoc_insertion_point(field_get:LGDDY.SC_stSmallGameInfo.icon_type)
...
inline void SC_stSmallGameInfo::set_icon_type(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:LGDDY.SC_stSmallGameInfo.icon_type)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_stSmallGameInfo::icon_type_conut() const {
  // @@protoc_insertion_point(field_get:LGDDY.SC_stSmallGameInfo.icon_type_conut)
...
inline void SC_stSmallGameInfo::set_icon_type_conut(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:LGDDY.SC_stSmallGameInfo.icon_type_conut)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_stSmallGameInfo::icon_type4(int index) const {
  // @@protoc_insertion_point(field_get:LGDDY.SC_stSmallGameInfo.icon_type4)
...
inline void SC_stSmallGameInfo::set_icon_type4(int index, ::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:LGDDY.SC_stSmallGameInfo.icon_type4)
}
...
inline void SC_stSmallGameInfo::add_icon_type4(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_add:LGDDY.SC_stSmallGameInfo.icon_type4)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int32 >&
...
SC_stSmallGameInfo::icon_type4() const {
  // @@protoc_insertion_point(field_list:LGDDY.SC_stSmallGameInfo.icon_type4)
...
SC_stSmallGameInfo::mutable_icon_type4() {
  // @@protoc_insertion_point(field_mutable_list:LGDDY.SC_stSmallGameInfo.icon_type4)
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_stSmallGameInfo::game_gold() const {
  // @@protoc_insertion_point(field_get:LGDDY.SC_stSmallGameInfo.game_gold)
...
inline void SC_stSmallGameInfo::set_game_gold(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:LGDDY.SC_stSmallGameInfo.game_gold)
}
...
inline bool SC_stSmallGameInfo::game_end() const {
  // @@protoc_insertion_point(field_get:LGDDY.SC_stSmallGameInfo.game_end)
...
inline void SC_stSmallGameInfo::set_game_end(bool value) {
  ...
  // @@protoc_insertion_point(field_set:LGDDY.SC_stSmallGameInfo.game_end)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_stSmallGameInfo::line_gold() const {
  // @@protoc_insertion_point(field_get:LGDDY.SC_stSmallGameInfo.line_gold)
  return _internal_line_gold();
}
...
inline void SC_stSmallGameInfo::set_line_gold(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_line_gold(value);
  // @@protoc_insertion_point(field_set:LGDDY.SC_stSmallGameInfo.line_gold)
}
...
template <> struct is_proto_enum< ::LGDDY::EMsgIDLGDDY> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::LGDDY::EMsgIDLGDDY>() {
  return ::LGDDY::EMsgIDLGDDY_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_LGDDY_2eproto
