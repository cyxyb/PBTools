...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_CS_Start_XML_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_CS_Start_XML_2eproto}, {}};

static void InitDefaultsscc_info_SC_CheckOut_XML_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_SC_CheckOut_XML_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_SC_CheckOut_XML_2eproto}, {}};

static void InitDefaultsscc_info_SC_SceneInfo_XML_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_SC_SceneInfo_XML_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_SC_SceneInfo_XML_2eproto}, {}};

static void InitDefaultsscc_info_SC_SyncGold_XML_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_SC_SyncGold_XML_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_SC_SyncGold_XML_2eproto}, {}};

static void InitDefaultsscc_info_SC_stSmallGameInfo_XML_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_SC_stSmallGameInfo_XML_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_SC_stSmallGameInfo_XML_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_XML_2eproto[5];
static const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* file_level_enum_descriptors_XML_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_XML_2eproto = nullptr;
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_XML_2eproto_sccs[5] = {
  &scc_info_CS_Start_XML_2eproto.base,
  &scc_info_SC_CheckOut_XML_2eproto.base,
  &scc_info_SC_SceneInfo_XML_2eproto.base,
  &scc_info_SC_SyncGold_XML_2eproto.base,
  &scc_info_SC_stSmallGameInfo_XML_2eproto.base,
};
...
const SC_CheckOut& SC_CheckOut::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_SC_CheckOut_XML_2eproto.base);
...
const CS_Start& CS_Start::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_CS_Start_XML_2eproto.base);
  return *internal_default_instance();
}
...
const SC_SyncGold& SC_SyncGold::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_SC_SyncGold_XML_2eproto.base);
  return *internal_default_instance();
}
...
const SC_SceneInfo& SC_SceneInfo::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_SC_SceneInfo_XML_2eproto.base);
  return *internal_default_instance();
}
...
const SC_stSmallGameInfo& SC_stSmallGameInfo::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_SC_stSmallGameInfo_XML_2eproto.base);
  return *internal_default_instance();
}
