...
#ifndef GOOGLE_PROTOBUF_INCLUDED_ALD_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_ALD_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_ALD_2eproto
...
struct TableStruct_ALD_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ALD_2eproto;
namespace ALD {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::ALD::CMD_3D_SC_Result* Arena::CreateMaybeMessage<::ALD::CMD_3D_SC_Result>(Arena*);
template<> ::ALD::Is_HitIcon* Arena::CreateMaybeMessage<::ALD::Is_HitIcon>(Arena*);
template<> ::ALD::SC_SceneInfo* Arena::CreateMaybeMessage<::ALD::SC_SceneInfo>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace ALD {
...
enum EMsgIDALD : int {
  ...
  EMsgIDALD_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  EMsgIDALD_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool EMsgIDALD_IsValid(int value);
constexpr EMsgIDALD EMsgIDALD_MIN = SUB_CS_GAME_START;
constexpr EMsgIDALD EMsgIDALD_MAX = SUB_SC_UPDATE_PRIZE_POOL;
constexpr int EMsgIDALD_ARRAYSIZE = EMsgIDALD_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* EMsgIDALD_descriptor();
template<typename T>
inline const std::string& EMsgIDALD_Name(T enum_t_value) {
  static_assert(::std::is_same<T, EMsgIDALD>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function EMsgIDALD_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    EMsgIDALD_descriptor(), enum_t_value);
}
inline bool EMsgIDALD_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, EMsgIDALD* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<EMsgIDALD>(
    EMsgIDALD_descriptor(), name, value);
}
// ===================================================================

class Is_HitIcon PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ALD.Is_HitIcon) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_ALD_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  // @@protoc_insertion_point(class_scope:ALD.Is_HitIcon)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_ALD_2eproto;
};
// -------------------------------------------------------------------

class SC_SceneInfo PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ALD.SC_SceneInfo) */ {
 public:
  ...
  public:
  void clear_is_hit();
  ::ALD::Is_HitIcon* mutable_is_hit(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::ALD::Is_HitIcon >*
      mutable_is_hit();
  private:
  const ::ALD::Is_HitIcon& _internal_is_hit(int index) const;
  ::ALD::Is_HitIcon* _internal_add_is_hit();
  public:
  const ::ALD::Is_HitIcon& is_hit(int index) const;
  ::ALD::Is_HitIcon* add_is_hit();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::ALD::Is_HitIcon >&
      is_hit() const;
  ...
  // @@protoc_insertion_point(class_scope:ALD.SC_SceneInfo)
 private:
  class _Internal;
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::ALD::Is_HitIcon > is_hit_;
...
class CMD_3D_SC_Result PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ALD.CMD_3D_SC_Result) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:ALD.CMD_3D_SC_Result)
 private:
  class _Internal;
...
inline bool Is_HitIcon::is_hit_icon(int index) const {
  // @@protoc_insertion_point(field_get:ALD.Is_HitIcon.is_hit_icon)
...
inline void Is_HitIcon::set_is_hit_icon(int index, bool value) {
  ...
  // @@protoc_insertion_point(field_set:ALD.Is_HitIcon.is_hit_icon)
}
...
inline void Is_HitIcon::add_is_hit_icon(bool value) {
  ...
  // @@protoc_insertion_point(field_add:ALD.Is_HitIcon.is_hit_icon)
}
...
Is_HitIcon::is_hit_icon() const {
  // @@protoc_insertion_point(field_list:ALD.Is_HitIcon.is_hit_icon)
...
Is_HitIcon::mutable_is_hit_icon() {
  // @@protoc_insertion_point(field_mutable_list:ALD.Is_HitIcon.is_hit_icon)
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_SceneInfo::cur_chip() const {
  // @@protoc_insertion_point(field_get:ALD.SC_SceneInfo.cur_chip)
...
inline void SC_SceneInfo::set_cur_chip(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:ALD.SC_SceneInfo.cur_chip)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_SceneInfo::chip_list(int index) const {
  // @@protoc_insertion_point(field_get:ALD.SC_SceneInfo.chip_list)
...
inline void SC_SceneInfo::set_chip_list(int index, ::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:ALD.SC_SceneInfo.chip_list)
}
...
inline void SC_SceneInfo::add_chip_list(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_add:ALD.SC_SceneInfo.chip_list)
}
...
SC_SceneInfo::chip_list() const {
  // @@protoc_insertion_point(field_list:ALD.SC_SceneInfo.chip_list)
...
SC_SceneInfo::mutable_chip_list() {
  // @@protoc_insertion_point(field_mutable_list:ALD.SC_SceneInfo.chip_list)
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_SceneInfo::fu_score(int index) const {
  // @@protoc_insertion_point(field_get:ALD.SC_SceneInfo.fu_score)
...
inline void SC_SceneInfo::set_fu_score(int index, ::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:ALD.SC_SceneInfo.fu_score)
}
...
inline void SC_SceneInfo::add_fu_score(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_add:ALD.SC_SceneInfo.fu_score)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int32 >&
...
SC_SceneInfo::fu_score() const {
  // @@protoc_insertion_point(field_list:ALD.SC_SceneInfo.fu_score)
...
SC_SceneInfo::mutable_fu_score() {
  // @@protoc_insertion_point(field_mutable_list:ALD.SC_SceneInfo.fu_score)
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_SceneInfo::icon(int index) const {
  // @@protoc_insertion_point(field_get:ALD.SC_SceneInfo.icon)
...
inline void SC_SceneInfo::set_icon(int index, ::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:ALD.SC_SceneInfo.icon)
}
...
inline void SC_SceneInfo::add_icon(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_add:ALD.SC_SceneInfo.icon)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int32 >&
...
SC_SceneInfo::icon() const {
  // @@protoc_insertion_point(field_list:ALD.SC_SceneInfo.icon)
...
SC_SceneInfo::mutable_icon() {
  // @@protoc_insertion_point(field_mutable_list:ALD.SC_SceneInfo.icon)
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_SceneInfo::gold_num(int index) const {
  // @@protoc_insertion_point(field_get:ALD.SC_SceneInfo.gold_num)
...
inline void SC_SceneInfo::set_gold_num(int index, ::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:ALD.SC_SceneInfo.gold_num)
}
...
inline void SC_SceneInfo::add_gold_num(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_add:ALD.SC_SceneInfo.gold_num)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int32 >&
...
SC_SceneInfo::gold_num() const {
  // @@protoc_insertion_point(field_list:ALD.SC_SceneInfo.gold_num)
...
SC_SceneInfo::mutable_gold_num() {
  // @@protoc_insertion_point(field_mutable_list:ALD.SC_SceneInfo.gold_num)
...
inline ::ALD::Is_HitIcon* SC_SceneInfo::mutable_is_hit(int index) {
  // @@protoc_insertion_point(field_mutable:ALD.SC_SceneInfo.is_hit)
  return is_hit_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::ALD::Is_HitIcon >*
SC_SceneInfo::mutable_is_hit() {
  // @@protoc_insertion_point(field_mutable_list:ALD.SC_SceneInfo.is_hit)
  return &is_hit_;
}
inline const ::ALD::Is_HitIcon& SC_SceneInfo::_internal_is_hit(int index) const {
  return is_hit_.Get(index);
}
inline const ::ALD::Is_HitIcon& SC_SceneInfo::is_hit(int index) const {
  // @@protoc_insertion_point(field_get:ALD.SC_SceneInfo.is_hit)
  return _internal_is_hit(index);
}
inline ::ALD::Is_HitIcon* SC_SceneInfo::_internal_add_is_hit() {
  return is_hit_.Add();
}
inline ::ALD::Is_HitIcon* SC_SceneInfo::add_is_hit() {
  // @@protoc_insertion_point(field_add:ALD.SC_SceneInfo.is_hit)
  return _internal_add_is_hit();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::ALD::Is_HitIcon >&
SC_SceneInfo::is_hit() const {
  // @@protoc_insertion_point(field_list:ALD.SC_SceneInfo.is_hit)
  return is_hit_;
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_SceneInfo::fu_type(int index) const {
  // @@protoc_insertion_point(field_get:ALD.SC_SceneInfo.fu_type)
...
inline void SC_SceneInfo::set_fu_type(int index, ::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:ALD.SC_SceneInfo.fu_type)
}
...
inline void SC_SceneInfo::add_fu_type(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_add:ALD.SC_SceneInfo.fu_type)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int32 >&
...
SC_SceneInfo::fu_type() const {
  // @@protoc_insertion_point(field_list:ALD.SC_SceneInfo.fu_type)
...
SC_SceneInfo::mutable_fu_type() {
  // @@protoc_insertion_point(field_mutable_list:ALD.SC_SceneInfo.fu_type)
...
inline ::PROTOBUF_NAMESPACE_ID::int64 SC_SceneInfo::line_win_score() const {
  // @@protoc_insertion_point(field_get:ALD.SC_SceneInfo.line_win_score)
...
inline void SC_SceneInfo::set_line_win_score(::PROTOBUF_NAMESPACE_ID::int64 value) {
  ...
  // @@protoc_insertion_point(field_set:ALD.SC_SceneInfo.line_win_score)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_SceneInfo::free_time() const {
  // @@protoc_insertion_point(field_get:ALD.SC_SceneInfo.free_time)
...
inline void SC_SceneInfo::set_free_time(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:ALD.SC_SceneInfo.free_time)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_SceneInfo::gold_mode_num() const {
  // @@protoc_insertion_point(field_get:ALD.SC_SceneInfo.gold_mode_num)
...
inline void SC_SceneInfo::set_gold_mode_num(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:ALD.SC_SceneInfo.gold_mode_num)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int64 SC_SceneInfo::total_rate() const {
  // @@protoc_insertion_point(field_get:ALD.SC_SceneInfo.total_rate)
...
inline void SC_SceneInfo::set_total_rate(::PROTOBUF_NAMESPACE_ID::int64 value) {
  ...
  // @@protoc_insertion_point(field_set:ALD.SC_SceneInfo.total_rate)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 CMD_3D_SC_Result::icon(int index) const {
  // @@protoc_insertion_point(field_get:ALD.CMD_3D_SC_Result.icon)
  return _internal_icon(index);
}
inline void CMD_3D_SC_Result::set_icon(int index, ::PROTOBUF_NAMESPACE_ID::int32 value) {
  icon_.Set(index, value);
  // @@protoc_insertion_point(field_set:ALD.CMD_3D_SC_Result.icon)
}
...
inline void CMD_3D_SC_Result::add_icon(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_add_icon(value);
  // @@protoc_insertion_point(field_add:ALD.CMD_3D_SC_Result.icon)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int32 >&
...
CMD_3D_SC_Result::icon() const {
  // @@protoc_insertion_point(field_list:ALD.CMD_3D_SC_Result.icon)
  return _internal_icon();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int32 >*
...
CMD_3D_SC_Result::mutable_icon() {
  // @@protoc_insertion_point(field_mutable_list:ALD.CMD_3D_SC_Result.icon)
  return _internal_mutable_icon();
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 CMD_3D_SC_Result::gold_num(int index) const {
  // @@protoc_insertion_point(field_get:ALD.CMD_3D_SC_Result.gold_num)
  return _internal_gold_num(index);
}
inline void CMD_3D_SC_Result::set_gold_num(int index, ::PROTOBUF_NAMESPACE_ID::int32 value) {
  gold_num_.Set(index, value);
  // @@protoc_insertion_point(field_set:ALD.CMD_3D_SC_Result.gold_num)
}
...
inline void CMD_3D_SC_Result::add_gold_num(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_add_gold_num(value);
  // @@protoc_insertion_point(field_add:ALD.CMD_3D_SC_Result.gold_num)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int32 >&
...
CMD_3D_SC_Result::gold_num() const {
  // @@protoc_insertion_point(field_list:ALD.CMD_3D_SC_Result.gold_num)
  return _internal_gold_num();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int32 >*
...
CMD_3D_SC_Result::mutable_gold_num() {
  // @@protoc_insertion_point(field_mutable_list:ALD.CMD_3D_SC_Result.gold_num)
  return _internal_mutable_gold_num();
}
...
inline ::ALD::Is_HitIcon* CMD_3D_SC_Result::mutable_is_hit(int index) {
  // @@protoc_insertion_point(field_mutable:ALD.CMD_3D_SC_Result.is_hit)
  return is_hit_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::ALD::Is_HitIcon >*
CMD_3D_SC_Result::mutable_is_hit() {
  // @@protoc_insertion_point(field_mutable_list:ALD.CMD_3D_SC_Result.is_hit)
  return &is_hit_;
}
inline const ::ALD::Is_HitIcon& CMD_3D_SC_Result::_internal_is_hit(int index) const {
  return is_hit_.Get(index);
}
inline const ::ALD::Is_HitIcon& CMD_3D_SC_Result::is_hit(int index) const {
  // @@protoc_insertion_point(field_get:ALD.CMD_3D_SC_Result.is_hit)
  return _internal_is_hit(index);
}
inline ::ALD::Is_HitIcon* CMD_3D_SC_Result::_internal_add_is_hit() {
  return is_hit_.Add();
}
inline ::ALD::Is_HitIcon* CMD_3D_SC_Result::add_is_hit() {
  // @@protoc_insertion_point(field_add:ALD.CMD_3D_SC_Result.is_hit)
  return _internal_add_is_hit();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::ALD::Is_HitIcon >&
CMD_3D_SC_Result::is_hit() const {
  // @@protoc_insertion_point(field_list:ALD.CMD_3D_SC_Result.is_hit)
  return is_hit_;
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 CMD_3D_SC_Result::fu_type(int index) const {
  // @@protoc_insertion_point(field_get:ALD.CMD_3D_SC_Result.fu_type)
  return _internal_fu_type(index);
}
inline void CMD_3D_SC_Result::set_fu_type(int index, ::PROTOBUF_NAMESPACE_ID::int32 value) {
  fu_type_.Set(index, value);
  // @@protoc_insertion_point(field_set:ALD.CMD_3D_SC_Result.fu_type)
}
...
inline void CMD_3D_SC_Result::add_fu_type(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_add_fu_type(value);
  // @@protoc_insertion_point(field_add:ALD.CMD_3D_SC_Result.fu_type)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int32 >&
...
CMD_3D_SC_Result::fu_type() const {
  // @@protoc_insertion_point(field_list:ALD.CMD_3D_SC_Result.fu_type)
  return _internal_fu_type();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int32 >*
...
CMD_3D_SC_Result::mutable_fu_type() {
  // @@protoc_insertion_point(field_mutable_list:ALD.CMD_3D_SC_Result.fu_type)
  return _internal_mutable_fu_type();
}
...
inline ::PROTOBUF_NAMESPACE_ID::int64 CMD_3D_SC_Result::line_win_score() const {
  // @@protoc_insertion_point(field_get:ALD.CMD_3D_SC_Result.line_win_score)
  return _internal_line_win_score();
}
...
inline void CMD_3D_SC_Result::set_line_win_score(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _internal_set_line_win_score(value);
  // @@protoc_insertion_point(field_set:ALD.CMD_3D_SC_Result.line_win_score)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 CMD_3D_SC_Result::free_time() const {
  // @@protoc_insertion_point(field_get:ALD.CMD_3D_SC_Result.free_time)
  return _internal_free_time();
}
...
inline void CMD_3D_SC_Result::set_free_time(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_free_time(value);
  // @@protoc_insertion_point(field_set:ALD.CMD_3D_SC_Result.free_time)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 CMD_3D_SC_Result::gold_mode_num() const {
  // @@protoc_insertion_point(field_get:ALD.CMD_3D_SC_Result.gold_mode_num)
  return _internal_gold_mode_num();
}
...
inline void CMD_3D_SC_Result::set_gold_mode_num(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_gold_mode_num(value);
  // @@protoc_insertion_point(field_set:ALD.CMD_3D_SC_Result.gold_mode_num)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int64 CMD_3D_SC_Result::total_rate() const {
  // @@protoc_insertion_point(field_get:ALD.CMD_3D_SC_Result.total_rate)
  return _internal_total_rate();
}
...
inline void CMD_3D_SC_Result::set_total_rate(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _internal_set_total_rate(value);
  // @@protoc_insertion_point(field_set:ALD.CMD_3D_SC_Result.total_rate)
}
...
template <> struct is_proto_enum< ::ALD::EMsgIDALD> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::ALD::EMsgIDALD>() {
  return ::ALD::EMsgIDALD_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_ALD_2eproto
