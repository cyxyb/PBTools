...
PROTOBUF_NAMESPACE_OPEN
template<> ::CS::CMD_3D_SC_Result* Arena::CreateMaybeMessage<::CS::CMD_3D_SC_Result>(Arena*);
template<> ::CS::LineType* Arena::CreateMaybeMessage<::CS::LineType>(Arena*);
template<> ::CS::SC_SceneInfo* Arena::CreateMaybeMessage<::CS::SC_SceneInfo>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace CS {
...
enum EMsgIDCS : int {
  ...
  EMsgIDCS_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  EMsgIDCS_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool EMsgIDCS_IsValid(int value);
constexpr EMsgIDCS EMsgIDCS_MIN = SUB_CS_GAME_START;
constexpr EMsgIDCS EMsgIDCS_MAX = SUB_SC_RESULTS_INFO;
constexpr int EMsgIDCS_ARRAYSIZE = EMsgIDCS_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* EMsgIDCS_descriptor();
template<typename T>
inline const std::string& EMsgIDCS_Name(T enum_t_value) {
  static_assert(::std::is_same<T, EMsgIDCS>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function EMsgIDCS_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    EMsgIDCS_descriptor(), enum_t_value);
}
inline bool EMsgIDCS_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, EMsgIDCS* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<EMsgIDCS>(
    EMsgIDCS_descriptor(), name, value);
}
// ===================================================================

class SC_SceneInfo PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CS.SC_SceneInfo) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:CS.SC_SceneInfo)
 private:
  class _Internal;
...
class LineType PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CS.LineType) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:CS.LineType)
 private:
  class _Internal;
...
class CMD_3D_SC_Result PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CS.CMD_3D_SC_Result) */ {
 public:
  ...
  public:
  void clear_line_type();
  ::CS::LineType* mutable_line_type(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CS::LineType >*
      mutable_line_type();
  private:
  const ::CS::LineType& _internal_line_type(int index) const;
  ::CS::LineType* _internal_add_line_type();
  public:
  const ::CS::LineType& line_type(int index) const;
  ::CS::LineType* add_line_type();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CS::LineType >&
      line_type() const;
  ...
  // @@protoc_insertion_point(class_scope:CS.CMD_3D_SC_Result)
 private:
  class _Internal;
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CS::LineType > line_type_;
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_SceneInfo::cur_chip() const {
  // @@protoc_insertion_point(field_get:CS.SC_SceneInfo.cur_chip)
...
inline void SC_SceneInfo::set_cur_chip(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:CS.SC_SceneInfo.cur_chip)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_SceneInfo::free_count() const {
  // @@protoc_insertion_point(field_get:CS.SC_SceneInfo.free_count)
...
inline void SC_SceneInfo::set_free_count(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:CS.SC_SceneInfo.free_count)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_SceneInfo::chip_list(int index) const {
  // @@protoc_insertion_point(field_get:CS.SC_SceneInfo.chip_list)
...
inline void SC_SceneInfo::set_chip_list(int index, ::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:CS.SC_SceneInfo.chip_list)
}
...
inline void SC_SceneInfo::add_chip_list(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_add:CS.SC_SceneInfo.chip_list)
}
...
SC_SceneInfo::chip_list() const {
  // @@protoc_insertion_point(field_list:CS.SC_SceneInfo.chip_list)
...
SC_SceneInfo::mutable_chip_list() {
  // @@protoc_insertion_point(field_mutable_list:CS.SC_SceneInfo.chip_list)
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_SceneInfo::line_rate(int index) const {
  // @@protoc_insertion_point(field_get:CS.SC_SceneInfo.line_rate)
...
inline void SC_SceneInfo::set_line_rate(int index, ::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:CS.SC_SceneInfo.line_rate)
}
...
inline void SC_SceneInfo::add_line_rate(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_add:CS.SC_SceneInfo.line_rate)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int32 >&
...
SC_SceneInfo::line_rate() const {
  // @@protoc_insertion_point(field_list:CS.SC_SceneInfo.line_rate)
...
SC_SceneInfo::mutable_line_rate() {
  // @@protoc_insertion_point(field_mutable_list:CS.SC_SceneInfo.line_rate)
...
inline ::PROTOBUF_NAMESPACE_ID::int64 SC_SceneInfo::god_score() const {
  // @@protoc_insertion_point(field_get:CS.SC_SceneInfo.god_score)
...
inline void SC_SceneInfo::set_god_score(::PROTOBUF_NAMESPACE_ID::int64 value) {
  ...
  // @@protoc_insertion_point(field_set:CS.SC_SceneInfo.god_score)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_SceneInfo::limit_chip() const {
  // @@protoc_insertion_point(field_get:CS.SC_SceneInfo.limit_chip)
...
inline void SC_SceneInfo::set_limit_chip(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:CS.SC_SceneInfo.limit_chip)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_SceneInfo::ilimit_chip() const {
  // @@protoc_insertion_point(field_get:CS.SC_SceneInfo.ilimit_chip)
...
inline void SC_SceneInfo::set_ilimit_chip(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:CS.SC_SceneInfo.ilimit_chip)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SC_SceneInfo::re_turn() const {
  // @@protoc_insertion_point(field_get:CS.SC_SceneInfo.re_turn)
...
inline void SC_SceneInfo::set_re_turn(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:CS.SC_SceneInfo.re_turn)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int64 SC_SceneInfo::jackpot() const {
  // @@protoc_insertion_point(field_get:CS.SC_SceneInfo.jackpot)
...
inline void SC_SceneInfo::set_jackpot(::PROTOBUF_NAMESPACE_ID::int64 value) {
  ...
  // @@protoc_insertion_point(field_set:CS.SC_SceneInfo.jackpot)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 LineType::line_type(int index) const {
  // @@protoc_insertion_point(field_get:CS.LineType.line_type)
...
inline void LineType::set_line_type(int index, ::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:CS.LineType.line_type)
}
...
inline void LineType::add_line_type(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_add:CS.LineType.line_type)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int32 >&
...
LineType::line_type() const {
  // @@protoc_insertion_point(field_list:CS.LineType.line_type)
...
LineType::mutable_line_type() {
  // @@protoc_insertion_point(field_mutable_list:CS.LineType.line_type)
...
inline ::PROTOBUF_NAMESPACE_ID::int32 CMD_3D_SC_Result::icon(int index) const {
  // @@protoc_insertion_point(field_get:CS.CMD_3D_SC_Result.icon)
...
inline void CMD_3D_SC_Result::set_icon(int index, ::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:CS.CMD_3D_SC_Result.icon)
}
...
inline void CMD_3D_SC_Result::add_icon(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_add:CS.CMD_3D_SC_Result.icon)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int32 >&
...
CMD_3D_SC_Result::icon() const {
  // @@protoc_insertion_point(field_list:CS.CMD_3D_SC_Result.icon)
...
CMD_3D_SC_Result::mutable_icon() {
  // @@protoc_insertion_point(field_mutable_list:CS.CMD_3D_SC_Result.icon)
...
inline ::CS::LineType* CMD_3D_SC_Result::mutable_line_type(int index) {
  // @@protoc_insertion_point(field_mutable:CS.CMD_3D_SC_Result.line_type)
  return line_type_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CS::LineType >*
CMD_3D_SC_Result::mutable_line_type() {
  // @@protoc_insertion_point(field_mutable_list:CS.CMD_3D_SC_Result.line_type)
  return &line_type_;
}
inline const ::CS::LineType& CMD_3D_SC_Result::_internal_line_type(int index) const {
  return line_type_.Get(index);
}
inline const ::CS::LineType& CMD_3D_SC_Result::line_type(int index) const {
  // @@protoc_insertion_point(field_get:CS.CMD_3D_SC_Result.line_type)
  return _internal_line_type(index);
}
inline ::CS::LineType* CMD_3D_SC_Result::_internal_add_line_type() {
  return line_type_.Add();
}
inline ::CS::LineType* CMD_3D_SC_Result::add_line_type() {
  // @@protoc_insertion_point(field_add:CS.CMD_3D_SC_Result.line_type)
  return _internal_add_line_type();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::CS::LineType >&
CMD_3D_SC_Result::line_type() const {
  // @@protoc_insertion_point(field_list:CS.CMD_3D_SC_Result.line_type)
  return line_type_;
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 CMD_3D_SC_Result::cai_shen_count() const {
  // @@protoc_insertion_point(field_get:CS.CMD_3D_SC_Result.cai_shen_count)
...
inline void CMD_3D_SC_Result::set_cai_shen_count(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:CS.CMD_3D_SC_Result.cai_shen_count)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 CMD_3D_SC_Result::free_count() const {
  // @@protoc_insertion_point(field_get:CS.CMD_3D_SC_Result.free_count)
  return _internal_free_count();
}
...
inline void CMD_3D_SC_Result::set_free_count(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_free_count(value);
  // @@protoc_insertion_point(field_set:CS.CMD_3D_SC_Result.free_count)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 CMD_3D_SC_Result::game_type() const {
  // @@protoc_insertion_point(field_get:CS.CMD_3D_SC_Result.game_type)
...
inline void CMD_3D_SC_Result::set_game_type(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:CS.CMD_3D_SC_Result.game_type)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int64 CMD_3D_SC_Result::win_score() const {
  // @@protoc_insertion_point(field_get:CS.CMD_3D_SC_Result.win_score)
...
inline void CMD_3D_SC_Result::set_win_score(::PROTOBUF_NAMESPACE_ID::int64 value) {
  ...
  // @@protoc_insertion_point(field_set:CS.CMD_3D_SC_Result.win_score)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 CMD_3D_SC_Result::temp() const {
  // @@protoc_insertion_point(field_get:CS.CMD_3D_SC_Result.temp)
...
inline void CMD_3D_SC_Result::set_temp(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:CS.CMD_3D_SC_Result.temp)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 CMD_3D_SC_Result::limit_chip() const {
  // @@protoc_insertion_point(field_get:CS.CMD_3D_SC_Result.limit_chip)
  return _internal_limit_chip();
}
...
inline void CMD_3D_SC_Result::set_limit_chip(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_limit_chip(value);
  // @@protoc_insertion_point(field_set:CS.CMD_3D_SC_Result.limit_chip)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 CMD_3D_SC_Result::limit_chip2() const {
  // @@protoc_insertion_point(field_get:CS.CMD_3D_SC_Result.limit_chip2)
...
inline void CMD_3D_SC_Result::set_limit_chip2(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:CS.CMD_3D_SC_Result.limit_chip2)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 CMD_3D_SC_Result::super_rate() const {
  // @@protoc_insertion_point(field_get:CS.CMD_3D_SC_Result.super_rate)
...
inline void CMD_3D_SC_Result::set_super_rate(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:CS.CMD_3D_SC_Result.super_rate)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 CMD_3D_SC_Result::re_turn() const {
  // @@protoc_insertion_point(field_get:CS.CMD_3D_SC_Result.re_turn)
  return _internal_re_turn();
}
...
inline void CMD_3D_SC_Result::set_re_turn(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_re_turn(value);
  // @@protoc_insertion_point(field_set:CS.CMD_3D_SC_Result.re_turn)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int64 CMD_3D_SC_Result::jackpot() const {
  // @@protoc_insertion_point(field_get:CS.CMD_3D_SC_Result.jackpot)
  return _internal_jackpot();
}
...
inline void CMD_3D_SC_Result::set_jackpot(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _internal_set_jackpot(value);
  // @@protoc_insertion_point(field_set:CS.CMD_3D_SC_Result.jackpot)
}
...
template <> struct is_proto_enum< ::CS::EMsgIDCS> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::CS::EMsgIDCS>() {
  return ::CS::EMsgIDCS_descriptor();
}
