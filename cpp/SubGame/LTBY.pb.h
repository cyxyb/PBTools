...
enum EMsgIDLTBY : int {
  ...
  EMsgIDLTBY_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  EMsgIDLTBY_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool EMsgIDLTBY_IsValid(int value);
constexpr EMsgIDLTBY EMsgIDLTBY_MIN = MsgIDSubGame_Null;
constexpr EMsgIDLTBY EMsgIDLTBY_MAX = SUB_C_PlayerCancelLock;
constexpr int EMsgIDLTBY_ARRAYSIZE = EMsgIDLTBY_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* EMsgIDLTBY_descriptor();
template<typename T>
inline const std::string& EMsgIDLTBY_Name(T enum_t_value) {
  static_assert(::std::is_same<T, EMsgIDLTBY>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function EMsgIDLTBY_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    EMsgIDLTBY_descriptor(), enum_t_value);
}
inline bool EMsgIDLTBY_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, EMsgIDLTBY* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<EMsgIDLTBY>(
    EMsgIDLTBY_descriptor(), name, value);
}
// ===================================================================
