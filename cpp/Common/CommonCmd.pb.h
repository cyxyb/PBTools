...
enum EMsgIDLogin : int {
  ...
  MsgIDShare_BindInviteCode = 138,
  MsgIDShare_BindInviteCodeResp = 139,
  MsgIDAgent_InfiniteQueryUserInfo = 140,
  ...
  MsgIDProp_GetPropInfo = 155,
  MsgIDProp_GetPropInfoResp = 156,
  MsgIDMail_DeleteMail = 157,
  MsgIDBank_GoldOperate = 158,
  MsgIDBank_GoldOperateResp = 159,
  MsgIDBank_GetRecord = 160,
  MsgIDBank_GetRecordResp = 161,
  MsgIDBank_ModifyPassword = 162,
  MsgIDBank_ModifyPasswordResp = 163,
  MsgIDLogin_SqueezeAccountResp = 164,
  MsgIDLogin_SyncRecallUserBankGold = 165,
  MsgIDLogin_QueryPlayerScoreRecord = 166,
  MsgIDLogin_QueryPlayerScoreRecordResp = 167,
...
constexpr EMsgIDLogin EMsgIDLogin_MAX = MsgIDLogin_QueryPlayerScoreRecordResp;
...
enum EMsgIDGame : int {
  ...
  MsgIDGame_Pvp_TableRoundChangeResp = 1069,
...
constexpr EMsgIDGame EMsgIDGame_MAX = MsgIDGame_Pvp_TableRoundChangeResp;
