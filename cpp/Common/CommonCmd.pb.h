...
enum EMsgIDLogin : int {
  ...
  MsgIDShop_BuyGoods = 96,
  MsgIDShop_BuyGoodsResp = 97,
  MsgIDShop_QueryTrumpetPrice = 98,
  MsgIDShop_QueryTrumpetPriceResp = 99,
  MsgIDLogin_QueryServerTime = 100,
  MsgIDLogin_QueryServerTimeResp = 101,
  MsgIDLogin_Heart = 102,
  MsgIDLogin_HeartResp = 103,
  MsgIDAgent_QuerySubAgentInfo = 104,
  ...
  MsgIDShare_QueryBindInfo = 110,
  MsgIDShare_QueryBindInfoResp = 111,
...
constexpr EMsgIDLogin EMsgIDLogin_MAX = MsgIDShare_QueryBindInfoResp;
...
constexpr EMsgIDChat EMsgIDChat_MAX = MsgIDChat_SyncUserInfoResp;
