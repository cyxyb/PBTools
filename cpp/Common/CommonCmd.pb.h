...
enum EMsgIDGame : int {
  ...
  MsgIDGame_CreateTable = 1013,
  MsgIDGame_JoinTable = 1014,
  ...
  MsgIDGame_Pvp_GetRoomConfigResp = 1021,
  MsgIDGame_Pvp_SendTableListResp = 1023,
  MsgIDGame_Pvp_ActivateTable = 1026,
  MsgIDGame_Pvp_ActivateTableResp = 1027,
  MsgIDGame_Pvp_KickUser = 1028,
  MsgIDGame_Pvp_KickUserResp = 1029,
  MsgIDGame_Pvp_DestroyTable = 1030,
  MsgIDGame_Pvp_DestroyTableResp = 1031,
  MsgIDGame_Pvp_FastJoinTable = 1032,
  MsgIDGame_Pvp_FastJoinTableResp = 1033,
  MsgIDGame_Pvp_SitDownResp = 1034,
  MsgIDGame_Pvp_StandUp = 1035,
  MsgIDGame_Pvp_StandResp = 1036,
...
constexpr EMsgIDGame EMsgIDGame_MAX = MsgIDGame_Pvp_StandResp;
