...
class MsgBindPhoneResp;
class MsgBindPhoneRespDefaultTypeInternal;
extern MsgBindPhoneRespDefaultTypeInternal _MsgBindPhoneResp_default_instance_;
...
template<> ::MsgBindPhoneResp* Arena::CreateMaybeMessage<::MsgBindPhoneResp>(Arena*);
...
class MsgBindPhoneResp PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:MsgBindPhoneResp) */ {
 public:
  inline MsgBindPhoneResp() : MsgBindPhoneResp(nullptr) {}
  virtual ~MsgBindPhoneResp();

  MsgBindPhoneResp(const MsgBindPhoneResp& from);
  MsgBindPhoneResp(MsgBindPhoneResp&& from) noexcept
    : MsgBindPhoneResp() {
    *this = ::std::move(from);
  }

  inline MsgBindPhoneResp& operator=(const MsgBindPhoneResp& from) {
    CopyFrom(from);
    return *this;
  }
  inline MsgBindPhoneResp& operator=(MsgBindPhoneResp&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const MsgBindPhoneResp& default_instance();

  static inline const MsgBindPhoneResp* internal_default_instance() {
    return reinterpret_cast<const MsgBindPhoneResp*>(
               &_MsgBindPhoneResp_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    51;

  friend void swap(MsgBindPhoneResp& a, MsgBindPhoneResp& b) {
    a.Swap(&b);
  }
  inline void Swap(MsgBindPhoneResp* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(MsgBindPhoneResp* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline MsgBindPhoneResp* New() const final {
    return CreateMaybeMessage<MsgBindPhoneResp>(nullptr);
  }

  MsgBindPhoneResp* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<MsgBindPhoneResp>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const MsgBindPhoneResp& from);
  void MergeFrom(const MsgBindPhoneResp& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(MsgBindPhoneResp* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "MsgBindPhoneResp";
  }
  protected:
  explicit MsgBindPhoneResp(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:MsgBindPhoneResp)
 private:
  class _Internal;
...
// int32 res_code = 1;
inline void MsgBindPhoneResp::clear_res_code() {
  res_code_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 MsgBindPhoneResp::_internal_res_code() const {
  return res_code_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 MsgBindPhoneResp::res_code() const {
  // @@protoc_insertion_point(field_get:MsgBindPhoneResp.res_code)
  return _internal_res_code();
}
inline void MsgBindPhoneResp::_internal_set_res_code(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  res_code_ = value;
}
inline void MsgBindPhoneResp::set_res_code(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_res_code(value);
  // @@protoc_insertion_point(field_set:MsgBindPhoneResp.res_code)
}

// int32 user_type = 2;
inline void MsgBindPhoneResp::clear_user_type() {
  user_type_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 MsgBindPhoneResp::_internal_user_type() const {
  return user_type_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 MsgBindPhoneResp::user_type() const {
  // @@protoc_insertion_point(field_get:MsgBindPhoneResp.user_type)
  return _internal_user_type();
}
inline void MsgBindPhoneResp::_internal_set_user_type(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  user_type_ = value;
}
inline void MsgBindPhoneResp::set_user_type(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_user_type(value);
  // @@protoc_insertion_point(field_set:MsgBindPhoneResp.user_type)
}
