...
enum EMsgIDServerInternalProto : int {
  ...
  LOGIN2CENTER_TransferSynchronousLogin = 23,
  CENTER2LOGIN_TransferSynchronousLoginResp = 24,
  ...
  CENTER2LOGIN_NotifyServerOfflinrResp = 30,
  LOGIN2CENTER_NotifyUpdateVipExp = 31,
  CENTER2LOGIN_NotifyUpdateVipExpResp = 32,
  LOGIN2CENTER_NotifyNewInviter = 33,
  ...
  CENTER2GAME_SqueezeAccount = 2009,
  ...
  RelayServer2CENTER_NotifyServerOffline = 5008,
  RelayServer2CENTER_WebCmd = 5009,
...
enum EMsgIDDB : int {
  ...
  LOGIN2DB_GetPlayerVipExp = 1029,
  DB2LOGIN_GetPlayerVipExpResp = 1030,
  ...
  LOGIN2DB_TransferOperate = 1052,
  DB2LOGIN_TransferOperateResp = 1053,
  LOGIN2DB_TransferRecord = 1054,
  DB2LOGIN_TransferRecordResp = 1055,
  LOGIN2DB_GetPlayerItem = 1056,
  DB2LOGIN_GetPlayerItemResp = 1057,
  LOGIN2DB_TransferQueryNickname = 1058,
  DB2LOGIN_TransferQueryNicknameResp = 1059,
  LOGIN2DB_BuyGoods = 1060,
  DB2LOGIN_BuyGoodsResp = 1061,
  LOGIN2DB_QueryTrumpetPrice = 1062,
  DB2LOGIN_QueryTrumpetPriceResp = 1063,
  LOGIN2DB_QuerySubAgentInfo = 1064,
  DB2LOGIN_QuerySubAgentInfoResp = 1065,
  LOGIN2DB_TransferReceive = 1066,
  DB2LOGIN_TransferReceiveResp = 1067,
  LOGIN2DB_BindInviteCode = 1068,
  DB2LOGIN_BindInviteCodeResp = 1069,
  LOGIN2DB_QueryShareInfo = 1070,
  DB2LOGIN_QueryShareInfoResp = 1071,
  LOGIN2DB_DotRechargeRecord = 1072,
  DB2LOGIN_DotRechargeRecordResp = 1073,
  LOGIN2DB_SyncDotData = 1074,
  LOGIN2DB_OnlineActiveQuery = 1075,
  ...
  LOGIN2DB_QueryCelebrityGoldCoin = 1089,
  DB2LOGIN_QueryCelebrityGoldCoinResp = 1090,
  LOGIN2DB_GetCelebrityGoldCoin = 1091,
  DB2LOGIN_GetCelebrityGoldCoinResp = 1092,
  LOGIN2DB_QueryInfiniteAgentMyInfo = 1093,
  DB2LOGIN_QueryInfiniteAgentMyInfoResp = 1094,
  LOGIN2DB_QueryInfiniteAgentSubInfo = 1095,
  DB2LOGIN_QueryInfiniteAgentSubInfoResp = 1096,
  LOGIN2DB_SetSubAgent = 1097,
  DB2LOGIN_SetSubAgentResp = 1098,
  LOGIN2DB_RecviveRebate = 1099,
  DB2LOGIN_RecviveRebateResp = 1100,
  LOGIN2DB_WeekMonthQuery = 1101,
  DB2LOGIN_WeekMonthQueryResp = 1102,
  ...
  DB2LOGIN_InfiniteQueryUserInfoResp = 1107,
  LOGIN2DB_QueryRechargeGiveInfo = 1108,
  DB2LOGIN_QueryRechargeGiveInfoResp = 1109,
  LOGIN2DB_GetClaimRecord = 1110,
  DB2LOGIN_GetClaimRecordResp = 1111,
  LOGIN2DB_GetPerformanceRecord = 1112,
  ...
  LOGIN2DB_GoldOperate = 1121,
  DB2LOGIN_GoldOperateResp = 1122,
  LOGIN2DB_GetGoldOperateRecord = 1123,
  ...
  GAME2DB_ApplyRobot = 2019,
  DB2GAME_ApplyRobotResp = 2020,
  GAME2DB_QueryPlayerGold = 2021,
  DB2GAME_QueryPlayerGoldResp = 2022,
  GAME2DB_ModifyProp = 2023,
