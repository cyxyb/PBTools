...
enum EMsgIDDB : int {
  ...
  LOGIN2DB_BankChangePassword = 1049,
  DB2LOGIN_BankChangePasswordResp = 1050,
  LOGIN2DB_BankOpenBank = 1051,
  DB2LOGIN_BankOpenBankResp = 1052,
  LOGIN2DB_BankOperate = 1053,
  DB2LOGIN_BankOperateResp = 1054,
  LOGIN2DB_BankTransfer = 1055,
  DB2LOGIN_BankTransferResp = 1056,
  LOGIN2DB_BankRecord = 1057,
  DB2LOGIN_BankRecordResp = 1058,
  GAME2DB_Login = 2001,
