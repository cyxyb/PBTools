...
class MsgGetPropInfo;
class MsgGetPropInfoDefaultTypeInternal;
extern MsgGetPropInfoDefaultTypeInternal _MsgGetPropInfo_default_instance_;
...
class MsgSitDownByTableNo;
class MsgSitDownByTableNoDefaultTypeInternal;
extern MsgSitDownByTableNoDefaultTypeInternal _MsgSitDownByTableNo_default_instance_;
...
template<> ::MsgGetPropInfo* Arena::CreateMaybeMessage<::MsgGetPropInfo>(Arena*);
...
template<> ::MsgSitDownByTableNo* Arena::CreateMaybeMessage<::MsgSitDownByTableNo>(Arena*);
...
class MsgSitDownByTableNo PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:MsgSitDownByTableNo) */ {
 public:
  inline MsgSitDownByTableNo() : MsgSitDownByTableNo(nullptr) {}
  virtual ~MsgSitDownByTableNo();

  MsgSitDownByTableNo(const MsgSitDownByTableNo& from);
  MsgSitDownByTableNo(MsgSitDownByTableNo&& from) noexcept
    : MsgSitDownByTableNo() {
    *this = ::std::move(from);
  }

  inline MsgSitDownByTableNo& operator=(const MsgSitDownByTableNo& from) {
    CopyFrom(from);
    return *this;
  }
  inline MsgSitDownByTableNo& operator=(MsgSitDownByTableNo&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const MsgSitDownByTableNo& default_instance();

  static inline const MsgSitDownByTableNo* internal_default_instance() {
    return reinterpret_cast<const MsgSitDownByTableNo*>(
               &_MsgSitDownByTableNo_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    3;

  friend void swap(MsgSitDownByTableNo& a, MsgSitDownByTableNo& b) {
    a.Swap(&b);
  }
  inline void Swap(MsgSitDownByTableNo* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(MsgSitDownByTableNo* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline MsgSitDownByTableNo* New() const final {
    return CreateMaybeMessage<MsgSitDownByTableNo>(nullptr);
  }

  MsgSitDownByTableNo* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<MsgSitDownByTableNo>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const MsgSitDownByTableNo& from);
  void MergeFrom(const MsgSitDownByTableNo& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(MsgSitDownByTableNo* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "MsgSitDownByTableNo";
  }
  protected:
  explicit MsgSitDownByTableNo(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:MsgSitDownByTableNo)
 private:
  class _Internal;
...
class MsgGetPropInfo PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:MsgGetPropInfo) */ {
 public:
  inline MsgGetPropInfo() : MsgGetPropInfo(nullptr) {}
  virtual ~MsgGetPropInfo();

  MsgGetPropInfo(const MsgGetPropInfo& from);
  MsgGetPropInfo(MsgGetPropInfo&& from) noexcept
    : MsgGetPropInfo() {
    *this = ::std::move(from);
  }

  inline MsgGetPropInfo& operator=(const MsgGetPropInfo& from) {
    CopyFrom(from);
    return *this;
  }
  inline MsgGetPropInfo& operator=(MsgGetPropInfo&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const MsgGetPropInfo& default_instance();

  static inline const MsgGetPropInfo* internal_default_instance() {
    return reinterpret_cast<const MsgGetPropInfo*>(
               &_MsgGetPropInfo_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    12;

  friend void swap(MsgGetPropInfo& a, MsgGetPropInfo& b) {
    a.Swap(&b);
  }
  inline void Swap(MsgGetPropInfo* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(MsgGetPropInfo* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline MsgGetPropInfo* New() const final {
    return CreateMaybeMessage<MsgGetPropInfo>(nullptr);
  }

  MsgGetPropInfo* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<MsgGetPropInfo>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const MsgGetPropInfo& from);
  void MergeFrom(const MsgGetPropInfo& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(MsgGetPropInfo* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "MsgGetPropInfo";
  }
  protected:
  explicit MsgGetPropInfo(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  ::MsgPropInfo* mutable_prop_info(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::MsgPropInfo >*
      mutable_prop_info();
  private:
  const ::MsgPropInfo& _internal_prop_info(int index) const;
  ::MsgPropInfo* _internal_add_prop_info();
  public:
  const ::MsgPropInfo& prop_info(int index) const;
  ::MsgPropInfo* add_prop_info();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::MsgPropInfo >&
      prop_info() const;

  // @@protoc_insertion_point(class_scope:MsgGetPropInfo)
 private:
  class _Internal;
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::MsgPropInfo > prop_info_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_Game_2eproto;
};
// -------------------------------------------------------------------
...
// int32 table_no = 1;
inline void MsgSitDownByTableNo::clear_table_no() {
  table_no_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 MsgSitDownByTableNo::_internal_table_no() const {
  return table_no_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 MsgSitDownByTableNo::table_no() const {
  // @@protoc_insertion_point(field_get:MsgSitDownByTableNo.table_no)
  return _internal_table_no();
}
inline void MsgSitDownByTableNo::_internal_set_table_no(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  table_no_ = value;
}
inline void MsgSitDownByTableNo::set_table_no(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_table_no(value);
  // @@protoc_insertion_point(field_set:MsgSitDownByTableNo.table_no)
}

// string password = 2;
inline void MsgSitDownByTableNo::clear_password() {
  password_.ClearToEmpty();
}
inline const std::string& MsgSitDownByTableNo::password() const {
  // @@protoc_insertion_point(field_get:MsgSitDownByTableNo.password)
  return _internal_password();
}
inline void MsgSitDownByTableNo::set_password(const std::string& value) {
  _internal_set_password(value);
  // @@protoc_insertion_point(field_set:MsgSitDownByTableNo.password)
}
inline std::string* MsgSitDownByTableNo::mutable_password() {
  // @@protoc_insertion_point(field_mutable:MsgSitDownByTableNo.password)
  return _internal_mutable_password();
}
inline const std::string& MsgSitDownByTableNo::_internal_password() const {
  return password_.Get();
}
inline void MsgSitDownByTableNo::_internal_set_password(const std::string& value) {
  
  password_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void MsgSitDownByTableNo::set_password(std::string&& value) {
  
  password_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:MsgSitDownByTableNo.password)
}
inline void MsgSitDownByTableNo::set_password(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  password_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:MsgSitDownByTableNo.password)
}
inline void MsgSitDownByTableNo::set_password(const char* value,
    size_t size) {
  ...
  password_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:MsgSitDownByTableNo.password)
}
inline std::string* MsgSitDownByTableNo::_internal_mutable_password() {
  
  return password_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* MsgSitDownByTableNo::release_password() {
  // @@protoc_insertion_point(field_release:MsgSitDownByTableNo.password)
  return password_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void MsgSitDownByTableNo::set_allocated_password(std::string* password) {
  if (password != nullptr) {
  ...
  password_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), password,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:MsgSitDownByTableNo.password)
}
...
// int32 prop_id = 1;
inline void MsgPropInfo::clear_prop_id() {
  prop_id_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 MsgPropInfo::_internal_prop_id() const {
  return prop_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 MsgPropInfo::prop_id() const {
  // @@protoc_insertion_point(field_get:MsgPropInfo.prop_id)
  return _internal_prop_id();
}
inline void MsgPropInfo::_internal_set_prop_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  prop_id_ = value;
}
inline void MsgPropInfo::set_prop_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_prop_id(value);
  // @@protoc_insertion_point(field_set:MsgPropInfo.prop_id)
}

// int32 prop_num = 2;
inline void MsgPropInfo::clear_prop_num() {
  prop_num_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 MsgPropInfo::_internal_prop_num() const {
  return prop_num_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 MsgPropInfo::prop_num() const {
  // @@protoc_insertion_point(field_get:MsgPropInfo.prop_num)
  return _internal_prop_num();
}
inline void MsgPropInfo::_internal_set_prop_num(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  prop_num_ = value;
}
inline void MsgPropInfo::set_prop_num(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_prop_num(value);
  // @@protoc_insertion_point(field_set:MsgPropInfo.prop_num)
}
...
// repeated .MsgPropInfo prop_info = 1;
inline int MsgGetPropInfo::_internal_prop_info_size() const {
  return prop_info_.size();
}
inline int MsgGetPropInfo::prop_info_size() const {
  return _internal_prop_info_size();
}
inline void MsgGetPropInfo::clear_prop_info() {
  prop_info_.Clear();
}
inline ::MsgPropInfo* MsgGetPropInfo::mutable_prop_info(int index) {
  // @@protoc_insertion_point(field_mutable:MsgGetPropInfo.prop_info)
  return prop_info_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::MsgPropInfo >*
MsgGetPropInfo::mutable_prop_info() {
  // @@protoc_insertion_point(field_mutable_list:MsgGetPropInfo.prop_info)
  return &prop_info_;
}
inline const ::MsgPropInfo& MsgGetPropInfo::_internal_prop_info(int index) const {
  return prop_info_.Get(index);
}
inline const ::MsgPropInfo& MsgGetPropInfo::prop_info(int index) const {
  // @@protoc_insertion_point(field_get:MsgGetPropInfo.prop_info)
  return _internal_prop_info(index);
}
inline ::MsgPropInfo* MsgGetPropInfo::_internal_add_prop_info() {
  return prop_info_.Add();
}
inline ::MsgPropInfo* MsgGetPropInfo::add_prop_info() {
  // @@protoc_insertion_point(field_add:MsgGetPropInfo.prop_info)
  return _internal_add_prop_info();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::MsgPropInfo >&
